...
def evaluate(trained_model, network, experiment_data_dir):
    ...
    cmd = 'cd ./widerface_evaluate && python3 setup.py build_ext --inplace && python3 evaluation.py --experiment_data_dir {}'.format(trained_model, network, experiment_data_dir)
